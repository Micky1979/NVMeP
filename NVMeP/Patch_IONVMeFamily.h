...
@"Mork vom Ork (patches collector) http://www.insanelymac.com/forum/topic/312803-patch-for-using-nvme-under-macos-sierra-is-ready/", nil]


@interface Patch_IONVMeFamily : NSObject
{
}
